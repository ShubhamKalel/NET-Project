...
namespace CoderOnline
{
    ...
    {
        private const string DbConnectionString = "Server=localhost;Database=net;Uid=shubham;Pwd=shubham;";
        ...
        private void InitializeAdminUser()
        {
            ...
            User adminUser = GetUserByUsername("shubham");
            if (adminUser == null)
            {
                // If not, create the admin user with a default password
                CreateUser("shubham", "shubham123", "shubham@gmail.com", 27);
            }
        }
